...
public class BbkPreIncludeDirectiveImpl extends ASTWrapperPsiElement implements BbkPreIncludeDirective {

  public BbkPreIncludeDirectiveImpl(@NotNull ASTNode node) {
    super(node);
  }
