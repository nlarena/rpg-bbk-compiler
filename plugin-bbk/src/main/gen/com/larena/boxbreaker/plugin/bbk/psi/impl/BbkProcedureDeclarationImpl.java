...
public class BbkProcedureDeclarationImpl extends ASTWrapperPsiElement implements BbkProcedureDeclaration {

  public BbkProcedureDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
