...
public class BbkSubroutineDefinitionImpl extends ASTWrapperPsiElement implements BbkSubroutineDefinition {

  public BbkSubroutineDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }
