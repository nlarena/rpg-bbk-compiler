...
public class BbkPrototypeDeclarationImpl extends ASTWrapperPsiElement implements BbkPrototypeDeclaration {

  public BbkPrototypeDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
