...
public class BbkExtnameDsModifierImpl extends ASTWrapperPsiElement implements BbkExtnameDsModifier {

  public BbkExtnameDsModifierImpl(@NotNull ASTNode node) {
    super(node);
  }
