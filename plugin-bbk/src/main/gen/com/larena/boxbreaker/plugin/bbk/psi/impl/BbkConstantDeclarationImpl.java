...
public class BbkConstantDeclarationImpl extends ASTWrapperPsiElement implements BbkConstantDeclaration {

  public BbkConstantDeclarationImpl(@NotNull ASTNode node) {
    super(node);
  }
