...
public class BbkBitwiseXorExpressionImpl extends ASTWrapperPsiElement implements BbkBitwiseXorExpression {

  public BbkBitwiseXorExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
