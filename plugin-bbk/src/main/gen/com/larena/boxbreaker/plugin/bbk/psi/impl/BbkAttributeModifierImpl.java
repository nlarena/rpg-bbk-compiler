...
public class BbkAttributeModifierImpl extends ASTWrapperPsiElement implements BbkAttributeModifier {

  public BbkAttributeModifierImpl(@NotNull ASTNode node) {
    super(node);
  }
