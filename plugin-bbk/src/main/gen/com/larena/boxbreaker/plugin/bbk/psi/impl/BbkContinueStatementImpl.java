...
public class BbkContinueStatementImpl extends ASTWrapperPsiElement implements BbkContinueStatement {

  public BbkContinueStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
